...
namespace ProyectoFinal_Progra_I
{
    ...
    public partial class Pacientes : Form
    {
        ...
        private void actualizarDatosPaciente()
        {
            ...
            {
                pbFotoPaciente.Image = Principal.imageList1.Images["Paciente.jpeg"];
            }
        ...
        private void btnAgregarFotoPaciente_Click(object sender, EventArgs e)
        {
            using (OpenFileDialog ofd = new OpenFileDialog())
            {
                ...
                {
                    pbFotoPaciente.Image = new Bitmap(ofd.FileName);
                }
            }
            /*
    private void Pacientes_Load(object sender, EventArgs e)
